...
public client class RepositoryInitResponseCaller {
    ...
    isolated remote function sendInitResponse(InitResponse response) returns grpc:Error? {
        return self.caller->send(response);
    }

    isolated remote function sendContextInitResponse(ContextInitResponse response) returns grpc:Error? {
        return self.caller->send(response);
    }
...
public client class RepositoryCratesCaller {
    private grpc:Caller caller;
    ...
    isolated remote function sendCrates(Crates response) returns grpc:Error? {
        return self.caller->send(response);
    }

    isolated remote function sendContextCrates(ContextCrates response) returns grpc:Error? {
        return self.caller->send(response);
    }
